...
fun main() = runBlocking {        //Executa na thread principal
        ...
        GlobalScope.launch {    // Thread: T1
            ...
            mySuspendFunc(1000)   // Coroutine está suspensa mas Thread: T1 está livre (não bloqueado)
            println("Fake work finished: ${Thread.currentThread().name}") // Ou T1 ou algum outro segmento.
        }

        mySuspendFunc(2000)  // thread principal: espere a corrotina terminar (praticamente não é a maneira correta de esperar)
